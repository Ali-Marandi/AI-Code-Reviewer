...
**AI-Code-Reviewer Enterprise** یک ابزار Local-first برای بازبینی کد، تحلیل ایستای امنیتی و مدیریت یافته‌ها در جریان GitHub است. نسخه v1.0.5 قابلیت اعمال قواعد سازمانی از طریق Rule Pack محلی، خروجی استاندارد SARIF و مشاهده روند محلی یافته‌ها را اضافه می‌کند.
...
| فیلد | الزام | توضیح |
|---|---|---|
| `schema_version` | بله | در v1.0.5 باید مقدار `1` باشد. |
